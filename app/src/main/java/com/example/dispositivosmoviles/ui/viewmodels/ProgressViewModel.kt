...
class ProgressViewModel : ViewModel(){
    ...
    val progressState = MutableLiveData<Int>(); //son como paquetes que engloba la varible

    val items = MutableLiveData<List<MarvelChars>>()

    fun proccesBackground(value: Long){
    ...
    suspend fun getMarvelChars(offset: Int, limit: Int){
        ...
        val newIteams=  MarvelLogic().getAllMarvelChars(offset,limit)
        items.postValue(newIteams)
    }
}